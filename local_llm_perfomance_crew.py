...
deepseek_agent = Agent(
    ...
    goal="Explain Dijkstra’s algorithm in a way that a beginner can understand, with a step-by-step breakdown and a code example in Java using Deepseek-R1.",
    backstory="A expert Java engineer with 30 years of experience in algorithmic problem-solving, utilizing Deepseek - R1 to craft efficient and optimized solutions.",
    verbose=True,
    llm=deepseek_llm,
)
